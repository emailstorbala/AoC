...
fn read_contents(content: String) -> HashMap<i32, Bag> {
    let mut game_details: HashMap<i32, Bag> = HashMap::new();
...
fn get_game_total(game_details: HashMap<i32, Bag>) -> i32 {
...
fn main() {
    ...
    let game_details = read_contents(content);
